...
def main(args):
    ...
    if args.loss == "CR_FIQA_LOSS":
        header = CR_FIQA_LOSS(in_features=cfg.embedding_size, out_features=cfg.num_classes, s=cfg.s, m=cfg.m).to(
            local_rank)
    else:
